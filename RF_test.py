...
plt.title('Random Forest Threshold = 0.4')
plt.xlabel('Predicted Labels')
plt.ylabel('Actual Labels')
plt.savefig("plot_cm_rf_4.png")
plt.show()
...
plt.savefig("plot_histogram_rf.png")
plt.show()
